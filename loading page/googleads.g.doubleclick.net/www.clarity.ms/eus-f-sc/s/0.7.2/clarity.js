/* clarity-js v0.7.2: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get start() {
            ...
            return st(this, (function(d) {
                switch (d.label) {
                    ...
                    case 1:
                        ...
                        e = tn.shift(), n = l(), a = 0, r = e.mutations, d.label = 2;
                    case 2:
                        return a < r.length ? (i = r[a], 0 !== (o = It(t)) ? [3, 4] : [4, Lt(t)]) : [3, 6];
                    case 3:
                        o = d.sent(), d.label = 4;
                    case 4:
                        if (2 === o) return [3, 6];
                        switch (u = i.target, c = function(t, e, n) {
                            ...
                            if (a && "HTML" !== a.data.tag) {
                                var r = l() > un,
                                    ...
                                    u = [a.selector ? a.selector.join() : "", o, t.attributeName, dn(t.addedNodes), dn(t.removedNodes)].join();
                                cn[u] = u in cn ? cn[u] : [0, n];
                                var c = cn[u];
                                if (!1 === r && c[0] >= 10 && fn(c[2], 2, e), c[0] = r ? c[1] === n ? c[0] : c[0] + 1 : 1, c[1] = n, 10 === c[0]) return c[2] = t.removedNodes, "suspend";
                                if (c[0] > 10) return ""
                            }
                            return t.type
                        }(i, t, n), c && u && u.ownerDocument && zn(u.ownerDocument), c && u && u.nodeType == Node.DOCUMENT_FRAGMENT_NODE && u.host && zn(u), c) {
                            case "attributes":
                                Je(u, 3);
                                break;
                            case "characterData":
    ...
    function vi() {
        $r() && (hi.slice().reverse().forEach((function(t) {
            return Hr(t.stop)()
        })), vt(), Qr(), void 0 !== mi && (mi[bi] = function() {
    ...
    function yi() {
        if (void 0 !== mi) {
            if (mi[bi] && mi[bi].v) return console.warn("Error CL001: Multiple Clarity tags detected.");
            var t = mi[bi] && mi[bi].q || [];
            for (mi[bi] = function(t) {
                    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                    return gi[t].apply(gi, e)
                }, mi[bi].v = d; t.length > 0;) mi[bi].apply(mi, t.shift())
        }
    }
    yi()
}();